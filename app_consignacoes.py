...
FILE_PATH = r"C:\CONSIGNEI\Consignacoes_Acumulado.xlsx"
...
def load_data():
    if os.path.exists(FILE_PATH):
        ...
        st.warning("Arquivo Excel não encontrado. Usando CSV...")
        df = pd.read_csv("Consignacoes_Acumulado.xlsx - Plan1.csv")
...
try:
    ...
    # 🔥 meses dependentes do ano selecionado
    ...
    st.download_button(
        ...
        data=to_excel(df_perm_view[
            ['Loja', 'Nome da Cliente', 'Nome da Consultora', 'NF', 'Total da Nota', 'Permanencia']
        ]),
